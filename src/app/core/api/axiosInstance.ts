...
const axiosInstance = axios.create({
  baseURL: "http://localhost/olympiad/api/school/",
  // baseURL: "http://lochanaragupathy.com/DataCleanupsAPIs/public/",
  // baseURL: "https://jeevitam.in/DataCleanup/DataCleanupsAPIs/public",
